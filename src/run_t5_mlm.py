...
class DataCollatorForT5MLM:
    ...
    def __call__(self, examples: List[Union[List[int], Any, Dict[str, Any]]]) -> Dict[str, Any]:
        ...
        input_ids_sentinel = self.create_sentinel_ids(mask_indices.type(torch.int8))
        labels_sentinel = self.create_sentinel_ids(labels_mask.type(torch.int8))
    ...
    def random_spans_noise_mask(self, length):
        ...
        def _random_segmentation(num_items, num_segments):
            ...
            idx = torch.randperm(mask_indices.shape[0])
            mask_indices = mask_indices[idx].view(mask_indices.size())
...
def main():
    ...
    if data_args.line_by_line:
        ...
        def tokenize_function(examples):
            return tokenizer(
                examples[text_column_name], return_special_tokens_mask=False
            )
    ...
    kwargs = {"finetuned_from": model_args.model_name_or_path, "tasks": "fill-mask", "dataset": data_args.dataset_name}
